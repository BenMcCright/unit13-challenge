...
def get_recommendation(risk_level):
    riskLevel = {"none": "100% bonds (AGG), 0% equities (SPY)",
    ...
    if age is not None:
        ...
        if age < 0:
            return build_validation_result(
                False,
                "age",
                "Your age must be a positive number")
            ...
            return build_validation_result(
                ...
                "enter an age younger than 65 years old")
    ...
    if investment_amount is not None:
        ...
        if investment_amount < 5000:
            return build_validation_result(
                ...
                "Please provide an investment amount greater than $5,000 USD")
